...
export const PrinterIcon = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.72 13.829c-.24.03-.48.062-.72.096m.72-.096a42.415 42.415 0 0 1 10.56 0m-10.56 0L6.34 18m10.94-4.171c.24.03.48.062.72.096m-.72-.096L17.66 18m0 0 .229 2.523a1.125 1.125 0 0 1-1.12 1.227H7.231c-.662 0-1.18-.568-1.12-1.227L6.34 18m11.32 0a42.671 42.671 0 0 0-10.94 0" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 7.5h-9a.75.75 0 0 0-.75.75v3.75c0 .414.336.75.75.75h9a.75.75 0 0 0 .75-.75v-3.75a.75.75 0 0 0-.75-.75Z" />
  </svg>
);
