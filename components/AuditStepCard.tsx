...
export function AuditStepCard({ step, onToggleCompletion }: AuditStepCardProps): React.ReactNode {
  const cardClasses = `
    bg-white rounded-xl shadow-md border transition-all duration-300 ease-in-out flex flex-col
